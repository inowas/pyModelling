...
class EvaluationRpcClient:
    ...
    def __init__(self, loop, host="rabbitmq", port=5672, virtual_host= "/", user="guest",
    ...
    async def call(self, json_data):
        ...
        await self.channel.default_exchange.publish(
            Message(
                json.dumps(json_data, default=self.numpy_type_translate).encode(),
